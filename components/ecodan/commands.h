...
DEFINE_COMMAND(zone2_room_temp, 7, CommandVarType_TEMPERATURE, SINGLE_ARG({0xfc, 0x41, 0x02, 0x7a, 0x10, 0x07, 0x01, 0x01, 0x00, 0x0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}));
